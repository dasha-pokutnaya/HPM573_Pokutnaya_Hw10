...
import MarkovModelHw10 as MarkovCls
import SupportMarkovModelHw10 as SupportMarkovTreat
...
PathCls.graph_sample_path(
    sample_path=simOutputs.get_sumStat_discounted_utility(),
...
SupportMarkovTreat.print_outcomes(simOutputs, 'Treatment:')
